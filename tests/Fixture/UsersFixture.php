...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'taluk_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'mobile_verified' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'role_id' => ['type' => 'unique', 'columns' => ['role_id', 'mobile_no'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_by' => 1,
                'updated_by' => 1,
                'created_date' => '2020-02-01 10:08:39',
                'modified_date' => 1580551719,
            ],
        ];
        parent::init();
    }

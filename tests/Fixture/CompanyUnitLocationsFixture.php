...
/**
 * CompanyUnitLocationsFixture
 */
class CompanyUnitLocationsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'order_flag' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'modified_on' => ['type' => 'timestamp', 'length' => null, 'null' => true, 'default' => 'CURRENT_TIMESTAMP', 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_active' => 1,
                'created_by' => 1,
                'created_on' => '2020-02-01 10:10:16',
                'modified_by' => 1,
                'modified_on' => 1580551816,
            ],
        ];
        parent::init();
    }

...
class CommunitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'order_flag' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_active' => 1,
                'created_by' => 1,
                'created_on' => 1578725438,
                'modified_by' => 1,
                'modified_on' => '2020-01-11 06:50:38',
            ],
        ];
        parent::init();
    }

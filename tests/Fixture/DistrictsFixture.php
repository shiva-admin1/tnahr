...
class DistrictsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name_eng' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'code' => ['type' => 'string', 'length' => 3, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'modified_on' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_active' => 1,
                'created_by' => 1,
                'created_on' => 1578725450,
                'modified_by' => 1,
                'modified_on' => '2020-01-11 06:50:50',
            ],
        ];
        parent::init();
    }

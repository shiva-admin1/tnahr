									...
									<fieldset  style="margin-left:1%;border:1px solid #00355F;border-radius:10px; margin-top:1%;">
									   <legend style="font-size:16px;margin-left:10px;color:#00355F;"><b>Record Request Details :</b></legend>
										<div class="col-md-12">
											...
											<div class="form-group" <?php if($rtiRequestRecord['document_status'] == ''){ ?> style="display:none;" <?php } ?>>											    
							...
							<?php $i++; } ?>				
							 ...
							 <?php } ?>
							  ...
							  <div class="col-md-12" style="margin-left:10px;">
							    <?php if(($rtiRequestRecord['application_status'] == 'Approved and Forwared to Sec Assistant By PIO') || ($rtiRequestRecord['application_status'] == 'Remarks and Forwared to Sec Assistant BY PIO')){  ?>
							     <fieldset  style="margin-left:0%;border:1px solid #00355F;border-radius:10px; margin-top:1%;">
								   <legend style="font-size:16px;margin-left:10px;color:#00355F;"><b>Status Update :</b></legend>
									<div class="col-md-12 sp">
									   <div class="form-group">											    
										...
										<div class="col-md-6">
											<div class="input text">
												<?php echo $this->Form->control('status_id',['class'=>'form-control','label'=>false,'error'=>false,'options'=>$finalstatuses,'empty'=>'Select','value'=>$current_status['status_id']]);?>
											</div>
										</div>																			
									 </div>
								   </div>
								   ...
								   <div class="col-md-12 sp">
									   <div class="form-group">							    
									 	<label for="inputContent" class="col-md-3 control-label bold">Putup Note<span class="require"></span></label>
										<div class="col-md-6">
											<div class="input text">
												<?php echo $this->Form->control('putup_note',['class'=>'form-control','label'=>false,'error'=>false,'type'=>'textarea','rows'=>2,'value'=>$current_status['putup_note']]);?>
											</div>
										</div>										
							   ...
							   <?php }else{  ?>
								<fieldset  style="margin-left:0%;border:1px solid #00355F;border-radius:10px; margin-top:1%;">
								   <legend style="font-size:16px;margin-left:10px;color:#00355F;"><b>Status Update :</b></legend>
									<div class="col-md-12 sp">
									   <div class="form-group">											    
										<label for="inputContent" class="col-md-3 control-label bold">Record Status<span class="require">*</span></label>
										<div class="col-md-3">
											<div class="input text">
												 <?php 
													if($doc_status == 'Record Searching'){
													echo $this->Form->control('rec_status_id',['class'=>'form-control','label'=>false,'error'=>false,'empty'=>'Select Status','options'=>$rec_status,onchange=>'checkStatus(this.value)','value' =>13]);
													}else{
													echo $this->Form->control('rec_status_id',['class'=>'form-control','label'=>false,'error'=>false,'empty'=>'Select Status','options'=>$rec_status,onchange=>'checkStatus(this.value)','value' =>$current_status['status_id']]);
												   }							
												?>
											</div>
										</div>
										<div class ="forwardstatus" style="display:none;">
										<label for="inputContent" class="col-md-3 control-label bold">Forward Status<span class="require">*</span></label>
										<div class="col-md-3">
											<div class="input text">
												<?php echo $this->Form->control('status_id',['class'=>'form-control','label'=>false,'error'=>false,'options'=>$statuses,'empty'=>'Select','value'=>$current_status['status_id']]);?>
											</div>
										</div>										
										</div>										
									 </div>
								   </div>
								   <div class="col-md-12 ud sp" style="display:none;">
										<div class="form-group">
											<label for="inputContent" class="col-md-3 control-label bold">Record
												Upload<span class="require">*</span></label>
											<div class="col-md-3">
												<div class="input text">
													<?php echo $this->Form->control('record_upload',['class'=>'form-control document_path resumeUpload','type'=>'file','label'=>false,'error'=>false,'required'=>'true','onchange'=>'validdocs1(this)']);?>
											...
											<label for="inputContent" class="col-md-3 control-label bold">Putup Note<span class="require">*</span></label>
												<div class="col-md-3">
													<div class="input text">
														<?php echo $this->Form->control('putup_note',['class'=>'form-control','label'=>false,'error'=>false,'type'=>'textarea','rows'=>2,'required'=>'true','value'=>$current_status['putup_note']]);?>
													</div>
												</div>											
											</div>	
										</div>
									</div>
									<?php if($rtiRequestRecord['document_fee'] == ''){  ?>
								   <div class="col-md-12 ud sp" style="display:none;">
									   <div class="form-group">											    
										<label for="inputContent" class="col-md-3 control-label bold">Document Fee<span class="require">*</span></label>
										<div class="col-md-3">
											<div class="input text">
												<?php echo $this->Form->control('document_fee',['class'=>'form-control num','label'=>false,'error'=>false,'type'=>'area','required'=>'true','maxlength'=>13,'min'=>1,'value'=>$rtiRequestRecord['document_fee']]);?>
											</div>
										</div>																				
									 </div>
								   </div>
								   <?php  }  ?>
								    <div class="col-md-12 forwardstatus sp">
									   <div class="form-group">											    
...
function checkStatus(status) {
    ...
    if(status == '13'){
       ...
       $('#putup-note').val(''); 	   
       $('#record-upload').val(''); 	   
	   $('#communication-to-applicant').val('');	  
	   $('#document-fee').val('');	
	   $('.ud').hide();	  
       $('.forwardstatus').hide();	  
	}else if (status == '4') {

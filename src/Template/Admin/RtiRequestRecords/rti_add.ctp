								   ...
								   <legend style="font-size:16px;margin-left:10px;color:#00355F;"><b>Application Type :</b></legend>
									<div class="col-md-12">
									   ...
									   <label for="inputContent" class="col-md-3 control-label bold">Request Type<span class="require">&nbsp;*</span></label>
										...
										<label for="inputContent" class="col-md-3 control-label bold">Application Request Type<span class="require">&nbsp;*</span></label>
										<div class="col-md-3">
											<div class="input text">
												<?php echo $this->Form->control('application_request_type',['class'=>'form-control','label'=>false,'error'=>false,'options'=>$app_types,'empty'=>'Select']);?>
											</div>
										</div>											
									 </div>
								   </div>
									   ...
									   <legend style="font-size:16px;margin-left:10px;color:#00355F;"><b>Personal Details :</b></legend>
										  <div class="col-md-12">
											<div class="form-group">											    
												...
												<div class="col-md-7">
													<div class="input text">
												        <?php echo $this->Form->control('applicant_name',['class'=>'form-control name','label'=>false,'error'=>false,'maxlength'=>'70','minlength'=>'2','placeholder'=>'Name']);?>
                                                	</div>
												</div>											
											 </div>
											 <div class="form-group">											    
												...
												<div class="col-md-7">
													<div class="input text">
												       <?php echo $this->Form->control('father_name',['class'=>'form-control name','label'=>false,'error'=>false,'maxlength'=>'70','minlength'=>'2','placeholder'=>'Father /Spouse Name']);?>
                                                    </div>
												</div>									
											 </div>
											<div class="form-group">											    
												...
												<div class="col-md-7">
													<div class="input text">
													    <?php echo $this->Form->control('mobile_no',['class'=>'form-control num','label'=>false,'error'=>false,'maxlength'=>'10','minlength'=>'10','placeholder'=>'Mobile No']);?>
                                                   </div>
												</div>											
											</div>
											<div class="form-group">						    
												...
												<div class="col-md-7">
													<div class="input text">
												       <?php echo $this->Form->control('email',['class'=>'form-control ','label'=>false,'error'=>false,'maxlength'=>'50','minlength'=>'2','placeholder'=>'Email']);?>
                                                	</div>
												</div>
											</div>					
											<div class="form-group">											    
												...
												<div class="col-md-7">
													<div class="input text">
												       <?php echo $this->Form->control('address',['class'=>'form-control ','label'=>false,'error'=>false,'maxlength'=>'250','minlength'=>'2','rows'=>2]);?>
                                                	</div>
												</div>										   
											</div>
											<div class="form-group">											    
											...
											<div class="form-group">											    
												...
												<div class="col-md-7">
													<div class="input text">
												       <?php echo $this->Form->control('taluk_id',['class'=>'form-control','label'=>false,'error'=>false,'options'=>'','empty'=>'Select Taluk']);?>
                                                	</div>
												</div>										   
											</div>
											<div class="form-group">											    
												...
												<div class="col-md-7">
													<div class="input text">
												       <?php echo $this->Form->control('pincode',['class'=>'form-control','label'=>false,'error'=>false,'maxlength'=>'6','minlength'=>'6','placeholder'=>'Pincode']);?>
                                                	</div>
												</div>										   
											</div>
										</div>
									   ...
									   <legend style="font-size:16px;margin-left:10px;color:#00355F;"><b>Record Request Details :</b></legend>
										<div class="col-md-12">										  
                                            ...
                                            <div class="form-group ifr_title" style="display:none;">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('title_deed_no',['class'=>'form-control ','label'=>false,'error'=>false,'maxlength'=>'50','minlength'=>'2','placeholder'=>'Title Deed No']);?>
                                                    </div>
                                                </div>
                                            </div>                                         
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('beic_general_no',['class'=>'form-control beic','label'=>false,'error'=>false,'maxlength'=>'50','minlength'=>'2','placeholder'=>'General No']);?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('beic_department',['class'=>'form-control ','label'=>false,'error'=>false,'maxlength'=>'50','minlength'=>'2','placeholder'=>'Department No']);?>
                                                    </div>
                                                </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('bp_no',['class'=>'form-control bp','label'=>false,'error'=>false,'maxlength'=>'50','minlength'=>'2','placeholder'=>'BP No']);?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('bp_abstract_subject',['class'=>'form-control ','label'=>false,'error'=>false,'maxlength'=>'50','minlength'=>'2','placeholder'=>'Abstract Subject']);?>
                                                    </div>
                                                </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('go_no',['class'=>'form-control go','label'=>false,'error'=>false,'maxlength'=>'50','minlength'=>'2','placeholder'=>'GO No']);?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('go_abstract_subject',['class'=>'form-control ','label'=>false,'error'=>false,'minlength'=>'2','placeholder'=>'Abstract Subject']);?>
                                                    </div>
                                                </div>
                                            </div>
                                            </div>
										    ...
										    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('gazettes_notification_no',['class'=>'form-control gazette','label'=>false,'error'=>false,'maxlength'=>'50','minlength'=>'2','placeholder'=>'Notification No']);?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
											...
											<div class="form-group  book" style="display:none;">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                       <?php echo $this->Form->control('book_subject',['class'=>'form-control alphanumeric','label'=>false,'error'=>false,'type'=>'text','placeholder'=>'Subject']);?>
                                                    </div>
                                                </div>
                                            </div>	
                                            </div>
											 ...
											 <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('document_request',['class'=>'form-control','label'=>false,'error'=>false,'required'=>true,'empty'=>'Select','options'=>['Hard copy'=>'Hard copy','Soft copy'=>'Soft copy']]);?>
                                                    </div>
                                                </div>
                                            </div>
											<div class="form-group">
...
$('#document-type-id').change(function() {
	...
	if(doctype != ''){
		$.ajax({
			async: true,
			dataType: "html",
			url: "<?php echo $this->Url->build('/', true)?>admin/rti_request_records/ajaxdocsubtype/" + doctype,
			method: 'get',
	...
	$('#book-title').val('');
	 ...
	 if(publisher != ''){
		$.ajax({
			async: true,
			dataType: "html",
			url: "<?php echo $this->Url->build('/', true)?>admin/rti_request_records/ajaxgetauthor/" + publisher,
			method: 'get',
			success: function(data, textStatus) { //alert();
...
$('#book-author').change(function() {
	 ...
	 if(author != ''){
		$.ajax({
			async: true,
			dataType: "html",
			url: "<?php echo $this->Url->build('/', true)?>admin/rti_request_records/ajaxgetbooktitle/" + author,
			method: 'get',
			success: function(data, textStatus) { //alert();
...
$('#district-id').change(function() {
	 ...
	 if(district_id != ''){
		$.ajax({
			async: true,
			dataType: "html",
			url: "<?php echo $this->Url->build('/', true)?>admin/rti_request_records/ajaxgettaluk/" + district_id,
			method: 'get',
			success: function(data, textStatus) { //alert();
				$('#taluk-id').html(data);
			}
...
$(function() {
    $("#FormID").validate({
        ...
        messages: {
			...
			'document_subtype_id' : {
                required        : "Select Record Sub Type"
            },
			'rti_request_type_id' : {

                        ...
                        <div class="panel-body pan">
                            <div class="form-body pal">								
								<div class="col-md-5">
									...
									<a  href="javascript:void(0);" style="color:red;margin-left:20px;" onclick ="show_details()"><i class="fas fa-user-tag"></i>&nbsp;<b>View Personal Details</b>&nbsp;&nbsp;<i class="fas fa-angle-down"></i></a><br><br>
												...
												<div class="col-md-12 col-xs-12">	
													<div class="col-md-12 col-xs-12 " >												       
													    <?php
													     ...
													     <?php  }if($rtiRequestRecord['dispatched_date'] != ''){ ?>
...
/*
$("#putnote").hover(function(){
    $('.putup').show().after('<br>');
},function(){   
	$('#putnote').find('br').remove();
    $('.putup').hide(); 

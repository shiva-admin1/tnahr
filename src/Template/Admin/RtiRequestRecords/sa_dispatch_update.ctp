								   ...
								   <legend style="font-size:16px;margin-left:10px;color:#00355F;"><b>Status Update :</b></legend>
									<div class="col-md-12">
									   <div class="form-group">					    
										...
										<div class="col-md-4">
											<div class="input text">
												<?php echo $this->Form->control('status_id',['class'=>'form-control','label'=>false,'error'=>false,'options'=>$status,'empty'=>'Select','value'=>$current_status['status_id'],'onchange'=>'loaddispatch(this.value)']);?>
											</div>
										</div>										
										</div>										
									 </div>								  
									<div class="col-md-12 dispatchdate" style="display:none;">
									   <div class="form-group">											    
								     ...
								     <div class="col-md-12 replyforward" style="display:none;">
									   <div class="form-group">										    
...
$(function() {
    $("#FormID").validate({
        ...
        messages: {
			...
			'communication_to_applicant': {
                required        : "Reply forward to Applicant"
            }

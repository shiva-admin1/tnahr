                    ...
                    <div class="sidebar-collapse menu-scroll">
                        <ul id="side-menu" class="nav">
                            ...
                            <li <?php if($this->request->getParam('controller') == 'dashboard'){?>class="active"
                                <?php }?>>
                                <?php  echo $this->Html->link('<i class="fas fa-chart-line">&nbsp;<div class="icon-bg bg-yellow"></div></i> <span class="menu-title">Digi Dashboard</span>',array('controller' => 'reports','action'=>'dashboard'), array('escape' => false,'class'=>''));?>
                            ...
                            <li <?php if($this->request->getParam('controller') == 'OsrRecords'){?>class="active"
                                <?php }?>>
                                <?php  echo $this->Html->link('<i class="fas fa-search">&nbsp;<div class="icon-bg bg-yellow"></div></i> <span class="menu-title">Find OSR Records</span>',array('controller' => 'OsrRecords','action'=>'searchosr'), array('escape' => false,'class'=>''));?>

                            </li>
                                                        
                             <li
                                <?php $reports = array('customize_detail_report','customize_userentry_report','record_count_report','customize_rti_report','doc_fee_report','user_count_report');echo (in_array($this->request->getParam('action'),$reports)) ? 'class="active"': ' ';?>>
                                <a href="#" id="colap">
                            ...
                            <li
                                <?php $masters = array('Districts','Taluks','DocumentTypes','DocumentSubtypes','Roles','AdminUsers','DepartmentSections');echo (in_array($this->request->getParam('controller'),$masters)) ? 'class="active"': ' ';?>>
                                <a href="#"  id="colap">
                            ...
                            <?php if(in_array($LOGGED_ROLE,array(3,4,5,9))){  ?> 
							 ...
							 <?php  } ?>
							  ...
							  <li
                                <?php $reports = array('customize_rti_report');echo (in_array($this->request->getParam('action'),$reports)) ? 'class="active"': ' ';?>>
                                <a href="#">
                                    <i class="fa fa-table fa-fw">
                                        <div class="icon-bg bg-blue"></div>
                                    </i>
							...
							<?php }  ?>
							 ...
							 <li
                                <?php $reports = array('customize_detail_report','customize_userentry_report','record_count_report','customize_rti_report','doc_fee_report');echo (in_array($this->request->getParam('action'),$reports)) ? 'class="active"': ' ';?>>
                                <a href="#" id="colap">
                                    <i class="fa fa-table fa-fw">
                                        <div class="icon-bg bg-blue"></div>
                                    </i>

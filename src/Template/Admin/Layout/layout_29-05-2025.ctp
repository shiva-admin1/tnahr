                    ...
                    <div class="sidebar-collapse menu-scroll">
                        <ul id="side-menu" class="nav">
                            ...
                            ?>
                                ...
                                <li <?php if ($this->request->getParam('controller') == 'PreRecords') { ?>class="active"
                                    <?php } ?>>
                                    <?php echo $this->Html->link('<i class="fas fa-file-alt fa-fw">&nbsp;<div class="icon-bg bg-yellow"></div></i> <span class="menu-title">Pre-Mutiny 1857 records(1670 to 1857 A.D)</span>', array('controller' => 'PreRecords', 'action' => 'index'), array('escape' => false, 'class' => '')); ?>
                                ...
                                <li <?php if ($this->request->getParam('controller') == 'GoRecords') { ?>class="active"
								   ...
								   <li <?php if ($this->request->getParam('controller') == 'Bmgazettes') { ?>class="active"
                                    <?php } ?>>
                                    <?php echo $this->Html->link('<i class="fas fa-clipboard-list fa-fw">&nbsp;<div class="icon-bg bg-yellow"></div></i> <span class="menu-title">Books/Manuals/ Gazetteers</span>', array('controller' => 'Bmgazettes', 'action' => 'index'), array('escape' => false, 'class' => '')); ?>
                                ...
                                <li> <?= $this->Html->link('<i class="fas fa-book fa-fw"><div class="icon-bg bg-yellow"></div></i> <span class="menu-title">Themes</span>','#',['escape' => false, 'class' => '']); ?>
                                </li>

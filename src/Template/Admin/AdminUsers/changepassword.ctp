...
<div class="row" oncontextmenu="return false;">
    <?php echo $this->Form->create('adminUsers',['class'=>'form-horizontal', 'id'=>'ChangePasswordForm','novalidate'=>'novalidate']); ?>
    <div class="col-lg-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group" id="Newpassword" style="display:none">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="input text">
                                                        <?php echo $this->Form->input('newpassword',['class'=>'form-control show-pass2','label'=>false,'placeholder'=>'New Password','error' => false,'type'=>'password','minlength'=>8,'maxlength'=>15]);?>
                                                    </div>
                                            ...
                                            <div class="form-group" id="Confirmpassword" style="display:none">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="input text">
                                                        <?php echo $this->Form->input('confirmpassword',['class'=>'form-control show-pass3','label'=>false,'placeholder'=>'Confirm Password','error' => false,'type'=>'password','minlength'=>8,'maxlength'=>15]);?>
                                                    </div>
                                                </div>
                                            </div>
...
$(function() {
 ...
 function sendpassword() {
        ...
        $.ajax({
            ...
            dataType: "html",
            type: "post",
            url: "<?php echo $this->Url->build(['controller' => 'AdminUsers', 'action' => 'verifypassword']) ?>",
            data: {
                password: password
            },

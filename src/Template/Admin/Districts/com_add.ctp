                ...
                <div class="col-lg-8">
                    <div class="panel portlet box portlet-red">
                        <div class="portlet-header">
                            <div class="caption">Add District used in IFR / OSR</div>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input text">
                                                            <?php echo $this->Form->control('name',['class'=>'form-control name','label'=>false,'error'=>false,'placeholder'=>'District Name']);?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="inputContent"
                                                        class="col-md-4 control-label bold">District Code <span
                                                            class="require">*</span></label>
                                                    <div class="col-md-6">
                                                        <div class="input text">
                                                            <?php //echo $this->Form->control('code',['class'=>'form-control alphanumeric','label'=>false,'error'=>false,'placeholder'=>'District Code']);?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div-->

                    ...
                    <div class="panel panel-red">
                        <div class="portlet box portlet-red">
                            <div class="portlet-header">
                                <div class="caption"><?php echo "Books/Manuals/ Gazetteers " ?></div>
                              <!--  <div class="actions">
                                    <?php echo $this->Html->link('<i class="fas fa-plus-circle"></i>&nbsp;Add Books/Manuals/ Gazetteers', array('action' => 'add'), array('escape' => false, 'class' => 'btn btn-outline-secondary', 'target' => '_blank')); ?>
                                </div>-->
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function documenttype(dist_id) {
        ...
        $.ajax({
            async: true,
            dataType: "html",
            url: "<?php echo $this->Url->build('/', true) ?>admin/bmgazettes/ajaxdocumenttypes/" + dist_id+"/"+preId,
            beforeSend: function(xhr) {
                xhr.setRequestHeader('X-CSRF-Token', $('[name="_csrfToken"]').val());
            },
            success: function(data, textStatus) {

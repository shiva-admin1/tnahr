                    ...
                    <div class="panel panel-red">
                        <div class="portlet box portlet-red">
                            <div class="portlet-header">
                                <div class="caption"><?php echo "Departments" ?></div>
                                <div class="actions">
                                    <?php echo $this->Html->link('<i class="fas fa-user-plus"></i>&nbsp;Add Department', array('action' => 'add'), array('escape' => false, 'class' => 'btn btn-outline-secondary', 'target' => '_blank')); ?>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <table id="table_id"
                                                ...
                                                <thead class='info'>
                                                    <tr>
                                                        ...
                                                        <th scope="col"><?php echo ('Department'); ?>
                                                        </th>

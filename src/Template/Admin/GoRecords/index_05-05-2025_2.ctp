	...
	if($('#document-subtype-id').val()!="" && $('#year-id').val()!=""){
            ...
            $('#bookTables').DataTable({
                ...
                "columns": [
					...
					"data": "path","title":"File",
					"render": function(data, type, row, meta) {
						return '<a href="<?php echo $this->Url->build('/', true) ?>uploads/e-Governance/' + data + '" target="_blank"><span style="color:#1ECBE4;"><i class="fas fa-file-pdf"></i>&nbsp;View Enclosure</span></a>';
					}
				}
				],
                "pageLength": 10,

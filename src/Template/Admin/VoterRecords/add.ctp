                ...
                <div class="col-lg-11">
                    <div class="panel portlet box portlet-red">
                        <div class="portlet-header">
                            <div class="caption">Add Voter List</div>
                        </div>
										...
										<div class="col-md-12">
										 ...
										 <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('district_name',['class'=>'form-control name','label'=>false,'error'=>false,'maxlength'=>'30','required'=>false,'minlength'=>'2','placeholder'=>'District']);?>
                                                    </div>
                                    ...
                                    <div class="col-md-6">									
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('taluk_name',['class'=>'form-control name','label'=>false,'error'=>false,'maxlength'=>'30','required'=>false,'minlength'=>'2','placeholder'=>'Taluk']);?>
                                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('village_name',['class'=>'form-control name','label'=>false,'error'=>false,'maxlength'=>'30','required'=>false,'minlength'=>'2','placeholder'=>'Village']);?>
                                                    </div>
										 ...
										 <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('keyword_tag',['class'=>'form-control alphanumericandcomma','label'=>false,'error'=>false,'required'=>false,'rows'=>'2','minlength'=>'1','placeholder'=>'Keywords / Tags']);?>
...
var yopval = $(yop).val();
		if( (parseInt(yopval)) <= 1600  || (parseInt(yopval) > current_year )){
			$(yop).val('');
			alert('Invalid Value');
		}
...
$(function() {
    $("#FormID").validate({
        ...
        messages: {
            ...
            'file_path': {
                required: "Upload a Voter Document"
            }
        },

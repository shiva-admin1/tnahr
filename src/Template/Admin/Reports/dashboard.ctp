                                            ...
                                            <div class="card" id="c-3">
												...
												<a href="../pre_records">
                                                    <div class="orange card-inner ">
                                                        ...
                                                        <div class="text-right">
                                                            <h4 class=" f-wgt-h orange">Pre-Mutiny records(1670 to 1857 A.D)</h4>
                                                ...
                                                <div class="card-body ">
                                                    <div class="voilet card-inner">
                                                        ...
                                                        <div class="text-right">
                                                            ...
                                                            <span class="voilet count">
                                                                <?php// echo ($bptotalcount[0]['totalrecordcount']) ? ($bptotalcount[0]['totalrecordcount']) : 0; ?>0
                                                            </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-inner">
                                                        ...
                                                        <div class="text-right">
                                                            ...
                                                            <span class="red count">
                                                                <?php //echo ($votertotalcount[0]['totalrecordcount']) ? ($votertotalcount[0]['totalrecordcount']) : 0; ?> 0
                                                            </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body ">
                                                        <div class="card-inner">
                                                            ...
                                                            <div class="text-right">
                                                                ...
                                                                <span class="count green">
                                                                    <?php //echo ($fmballcount[0]['totalrecordcount']) ? ($fmballcount[0]['totalrecordcount']) : 0; ?> 0
                                                                </span>
                                                            </div>
                                                        </div>

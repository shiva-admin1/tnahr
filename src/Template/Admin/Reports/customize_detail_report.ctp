            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-red">
                        <div class="portlet box portlet-red">
                            <div class="portlet-header">
                                <div class="caption"><?php echo "Detail Records"?></div>
                            </div>
                        </div>
                        ...
                        <div class="panel-body pan">
                            <div class="form-body pal">
                                <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input text">
                                                    <?php echo $this->Form->control('report_type',['class'=>'form-control','label'=>'Record Type','error'=>false,'empty'=>'Select Record Type','options'=>$reportTypes]);?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 go_filter" <?php if($report_type !=4){?>style="display:none;" <?php } ?>>
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <div class="input text">
                                    ...
                                    <div class="col-md-3 beic_filter" <?php if($report_type !=6){?>style="display:none;" <?php } ?>>
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <div class="input text">
									...
									<div class="col-md-3 doctype" <?php if($report_type == 3){ ?>
									 ...
									 <div class="col-md-3 vr_const" <?php if($report_type != 8){ ?>
                                                    style="display:none;" <?php } ?>>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input text">
                                ...
                                <div class="ifr_filter" <?php if($report_type !=3){?>style="display:none;" <?php } ?>>
									<div class="col-md-3">
										<div class="form-group">
											<div class="col-md-12">
												<div class="input text">
                                ...
                                <div class="br_filter" <?php if($report_type !=9){?>style="display:none;" <?php } ?>>
									<div class="col-md-3
										<div class="form-group">
											<div class="col-md-12">
												<div class="input text brauthor"
													<?php if($subtype_id != 44){  ?>style="display:none;"
													<?php } ?>>
									...
									<div class="col-md-3">
										<div class="form-group">
											<div class="col-md-12">
												<div class="input text brpublisher" <?php if($subtype_id != 44){  ?>
													style="display:none;" <?php } ?>>
                                ...
                                <div class="fmb_filter" <?php if($report_type !=1){?>style="display:none;" <?php } ?>>
                                    <div class="col-md-12">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="col-md-12">
                                ...
                                <div class="osr_filter" <?php if($report_type !=2){?>style="display:none;" <?php } ?>>
                                    <div class="col-md-12">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="col-md-12">
                                ...
                                <div class="voter_filter" <?php if($report_type !=8){?>style="display:none;" <?php } ?>>
                                    <div class="col-md-12">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="col-md-12">
                    ...
                    <div class="panel panel-red">
                        <div class="panel-body pan">
                            <div class="form-body pal">
                               <a href="#" id="export_excel_button1" title="fmb_details" style="float:right;"><img title="Excelsheet" src="<?php echo $this->Url->build('/', true)?>webroot/img/excel.png" height="22px"></a><br><br>
                                            ...
                                            <table id="table_id"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $records['survey_no'] ?></td>
                                                        <td><?php echo $records['doc_year'] ?></td>
                                                        <td><?php echo $records['page_no'] ?></td>
                                                        <td class="actions">

                                                            <?php echo $this->Html->link(__('<i class="fa fa-eye"></i>&nbsp;View'), ['controller'=> 'FmbRecords','action' => 'view', $records['id']], ['escape' => false,'class'=>'btn btn-warning btn-xs']); ?>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-body pan">
                            <div class="form-body pal">
                                <a href="#" id="export_excel_button2" title="osr_records" style="float:right;"><img title="Excelsheet" src="<?php echo $this->Url->build('/', true)?>webroot/img/excel.png" height="22px"></a><br><br>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="actions">
                                                            ...
                                                            <?php echo $this->Html->link(__('<i class="fa fa-eye"></i>&nbsp;View'), ['controller'=> 'OsrRecords','action' => 'view', $records['id']], ['escape' => false,'class'=>'btn btn-warning btn-xs']); ?>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-body pan">
                            <div class="form-body pal">
                                   <a href="#" id="export_excel_button3" title="ifr_records" style="float:right;"><img title="Excelsheet" src="<?php echo $this->Url->build('/', true)?>webroot/img/excel.png" height="22px"></a><br><br>
                                            ...
                                            <table id="table_id"
                                                ...
                                                <thead class="info">
                                                    <tr>
                                                        ...
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('village_name'); ?>
                                                        </th>
                                                        <th scope="col">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $ifr['title_deed_no']; ?></td>
                                                        <td><?php echo $ifr['sheet_no']; ?></td>
                                                        <td>
                                                            <a target="_blank"
                                                                href="<?php echo $this->Url->build('/', true)?><?php echo $ifr['file_path']; ?>"><span
                                                                    style="color:#1ECBE4;">View Document</span>
                                                            </a>
                                                        </td>
                                                        <!-- <td><?php echo($ifr->village_id->name); ?></td> -->
                                                        <td class="actions">
                                                            <?php echo $this->Html->link(__('<i class="fa fa-eye"></i>&nbsp;View'), ['controller'=> 'IfrRecords','action' => 'view', $ifr['id']], ['escape' => false,'class'=>'btn btn-warning btn-xs']); ?>
                                                        </td>
                                                    </tr>
                                                    <?php $sno++; endforeach; ?>
                                                </tbody>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-body pan">
                            <div class="form-body pal">
                                 <a href="#" id="export_excel_button4" title="go_records" style="float:right;"><img title="Excelsheet" src="<?php echo $this->Url->build('/', true)?>webroot/img/excel.png" height="22px"></a><br><br>
                                            ...
                                            <table id="table_id"
                                                ...
                                                <thead class="info">
                                                    <tr>
                                                        ...
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('go_type'); ?></th>
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('department'); ?>
                                                        </th>
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('go_no'); ?>
                                                        </th>
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('go_date'); ?>
                                                        </th>
                                                        <th scope="col">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="actions">
                                                            <?php echo $this->Html->link(__('<i class="fa fa-eye"></i>&nbsp;View'), ['controller'=> 'GoRecords','action' => 'view', $go['id']], ['escape' => false,'class'=>'btn btn-warning btn-xs']); ?>
                                                        </td>
                                                    </tr>
                                                    <?php $sno++; endforeach; ?>
                                                </tbody>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-body pan">
                            <div class="form-body pal">
                                  <a href="#" id="export_excel_button5" title="bp_records" style="float:right;"><img title="Excelsheet" src="<?php echo $this->Url->build('/', true)?>webroot/img/excel.png" height="22px"></a><br><br>
                                            ...
                                            <table id="table_id"
                                                ...
                                                <thead class="info">
                                                    <tr>
                                                        ...
                                                        <th scope="col"><?php echo $this->Paginator->sort('BP_Type'); ?>
                                                        </th>
                                                        ...
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('keyword_tag'); ?>
                                                        </th>
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('Document'); ?></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo($bp->bp_no); ?></td>
                                                        <td><?php echo date('d-m-Y',strtotime($bp->bp_date)); ?></td>
                                                        <td><?php echo($bp->abstract_subject); ?></td>
                                                        <td><?php echo($bp->keyword_tag); ?></td>
                                                        ...
                                                        <td class="actions">
                                                            <?php echo $this->Html->link(__('<i class="fa fa-eye"></i>&nbsp;View'), ['controller' => 'BpRecords','action' => 'view', $bp->id], ['escape' => false,'class'=>'btn btn-warning btn-xs']); ?>
                                                        </td>
                                                    </tr>
                                                    <?php $sno++; endforeach; ?>
                                                </tbody>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-body pan">
                            <div class="form-body pal">
                                   <a href="#" id="export_excel_button6" title="beic_records" style="float:right;"><img title="Excelsheet" src="<?php echo $this->Url->build('/', true)?>webroot/img/excel.png" height="22px"></a><br><br>
                                            ...
                                            <table id="table_id"
                                                ...
                                                <thead class="info">
                                                    <tr>
                                                        ...
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('document_subtype_id') ?>
                                                        </th>
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('department') ?>
                                                        </th>

                                                        <th scope="col"><?php echo $this->Paginator->sort('fromdate') ?>
                                                        </th>
                                                        <th scope="col"><?php echo $this->Paginator->sort('todate') ?>
                                                        </th>
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('general_no') ?></th>
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('volume_no') ?></th>
                                                        <th scope="col"><?php echo $this->Paginator->sort('document') ?>
                                                        </th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo date('d-m-Y',strtotime($beicRecord['fromdate'])) ?>
                                                        </td>
                                                        <td><?php echo date('d-m-Y',strtotime($beicRecord['todate'])) ?>
                                                        </td>
                                                        <td><?php echo $beicRecord['general_no'] ?></td>
                                                        <td><?php echo $beicRecord['volume_no'] ?></td>
                                                        <td> <a target="_blank"
                                                                href="<?php echo $this->Url->build('/', true)?><?php echo $beicRecord['file_path']; ?>"><span
                                                                    style="color:#1ECBE4;">View Document</span>
                                                            </a></td>
                                                        <td>
                                                            <?php echo $this->Html->link(__('<i class="fa fa-eye"></i>&nbsp;View'), ['controller' => 'BeicRecords','action' => 'view', $beicRecord['id']], ['escape' => false,'class'=>'btn btn-warning  btn-xs']) ?>
                                                        </td>
                                                    </tr>
                                                    <?php $sno++; endforeach; ?>
                                                </tbody>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-body pan">
                            <div class="form-body pal">
                                 <a href="#" id="export_excel_button7" title="gazette_records" style="float:right;"><img title="Excelsheet" src="<?php echo $this->Url->build('/', true)?>webroot/img/excel.png" height="22px"></a><br><br>
                                            ...
                                            <table id="table_id"
                                                ...
                                                <thead class="info">
                                                    <tr>
                                                        ...
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('Gazettes_Type'); ?></th>
                                                        <th scope="col">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo($gazette->notification_no); ?></td>
                                                        <td><?php echo date('d-m-Y',strtotime($gazette->notification_date)); ?>
                                                        </td>
                                                        ...
                                                        <td class="actions">
                                                            <?php echo $this->Html->link(__('<i class="fa fa-eye"></i>&nbsp;View'), ['controller'=> 'Gazettes','action' => 'view', $gazette->id], ['escape' => false,'class'=>'btn btn-warning btn-xs']); ?>
                                                        </td>
                                                    </tr>
                                                    <?php $sno++; endforeach; ?>
                                                </tbody>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-body pan">
                            <div class="form-body pal">
                               <a href="#" id="export_excel_button8" title="voter_records" style="float:right;"><img title="Excelsheet" src="<?php echo $this->Url->build('/', true)?>webroot/img/excel.png" height="22px"></a><br><br>
                                            ...
                                            <table id="table_id"
                                                ...
                                                <thead class="info">
                                                    <tr>
                                                        ...
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('constituency_name'); ?>
                                                        </th>
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('district_name'); ?>
                                                        </th>
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('taluk_name'); ?>
                                                        </th>
                                                        <th scope="col">
                                                            <?php echo $this->Paginator->sort('village_name'); ?>
                                                        </th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $voterRecord['constituency_no']; ?></td>
                                                        ...
                                                        <td class="actions">
                                                            <center>
                                                                <?php echo $this->Html->link(__('<i class="fa fa-eye"></i>&nbsp;View'), ['controller' => 'VoterRecords','action' => 'view', $voterRecord['id']], ['escape' => false,'class'=>'btn btn-warning btn-xs']); ?>
                                                            </center>
                                                        </td>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-body pan">
                            <div class="form-body pal">
                                 <a href="#" id="export_excel_button9" title="book_records" style="float:right;"><img title="Excelsheet" src="<?php echo $this->Url->build('/', true)?>webroot/img/excel.png" height="22px"></a><br><br>
                                            ...
                                            <table id="table_id"
                                                ...
                                                <thead class="info">
                                                    <tr>
                                                        ...
                                                        <?php }else{ echo "<style>.publisher{display:none;}</style>";?>
                                                        <?php }?>
                                                        <th scope="col">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $bookRecord['publication_year'] ?></td>
                                                        <?php if($subtype_id == '44'){ ?>
                                                        <td class="publisher">
                                                            <?php echo $bookRecord['publisher_name'] ?></td>
                                                        <?php }else{ echo "<style>.publisher{display:none;}</style>";?>
                                                        <?php }?>
                                                        <td><?php echo $bookRecord['accession_no'] ?></td>
                                                        <td><?php echo $bookRecord['catalogue_no'] ?></td>
                                                        <td>
                                                            <a target="_blank"
                                                        ...
                                                        <td>
                                                            <?php echo $this->Html->link(__('<i class="fa fa-eye"></i>&nbsp;View'), ['controller' => 'BookRecords','action' => 'view', $bookRecord['id']], ['escape' => false,'class'=>'btn btn-warning  btn-xs']) ?>
                                                        </td>
                                                    </tr>
                                                    <?php $sno++; endforeach; ?>
                                                </tbody>
...
<div id="fmbrecords" style="display:none;">
	<div class="table-responsive" style="overflow:auto">
		<table>
			<thead class="info">
				<tr>
...
<div id ="ifrrecords" style="display:none;">
	<div class="table-responsive" style="overflow:auto">
		<table>
			<thead class="info">
				<tr>
...
<div id="osrrecord" style="display:none;">
	<div class="table-responsive" style="overflow:none">
		<table>
			<thead class="info">
				<tr>
...
<div id ="gorecords" style="display:none;">
	<div class="table-responsive" style="overflow:auto">
		<table>
			<thead class="info">
				<tr>
...
<div id="bprecords" style="display:none;">
	<div class="table-responsive" style="overflow:auto">
		<table>
			<thead class="info">
				<tr>
...
<div id="beicrecords" style="display:none;">
	<div class="table-responsive" style="overflow:auto">
		<table>
			<thead class="info">
				<tr>
...
<div id="gazetterecords" style="display:none;">
	<div class="table-responsive" style="overflow:auto">
		<table>
			<thead class="info">
				<tr>
...
<div id="voterrecords" style="display:none;">
	<div class="table-responsive" style="overflow:auto">
		<table>
			<thead class="info">
				<tr>
...
<div id="bookrecords" style="display:none;">
<div class="table-responsive" style="overflow:auto">
	<table>
		<thead class="info">
			<tr>
...
var date = <?php echo date('Y_m_d_H_i_s'); ?>;
    $(function(){
    	$("#export_excel_button1").click(function () {		    
			var filename = "FMB_record_details_"+date;
			var uri = $("#fmbrecords").btechco_excelexport({
					containerid: "fmbrecords", 
...
var date = <?php echo date('Y_m_d_H_i_s'); ?>;
    $(function(){
    	$("#export_excel_button2").click(function () {		    
			var filename = "OSR_record_details_"+date;
			var uri = $("#osrrecord").btechco_excelexport({
					containerid: "osrrecord", 
					datatype: $datatype.Table,
					returnUri: true
...
var date = <?php echo date('Y_m_d_H_i_s'); ?>;
    $(function(){
    	$("#export_excel_button3").click(function () {		    
			var filename = "IFR_record_details_"+date;
			var uri = $("#ifrrecords").btechco_excelexport({
					containerid: "ifrrecords", 
					datatype: $datatype.Table,
					returnUri: true
...
var date = <?php echo date('Y_m_d_H_i_s'); ?>;
    $(function(){
    	$("#export_excel_button4").click(function () {		    
			var filename = "GO_record_details"+date;
			var uri = $("#gorecords").btechco_excelexport({
					containerid: "gorecords", 
					datatype: $datatype.Table,
					returnUri: true
...
var date = <?php echo date('Y_m_d_H_i_s'); ?>;
    $(function(){
    	$("#export_excel_button5").click(function () {		    
			var filename = "BP_record_details"+date;
			var uri = $("#bprecords").btechco_excelexport({
					containerid: "bprecords", 
					datatype: $datatype.Table,
					returnUri: true
...
var date = <?php echo date('Y_m_d_H_i_s'); ?>;
    $(function(){
    	$("#export_excel_button6").click(function () {		    
			var filename = "BEIC_record_details"+date;
			var uri = $("#beicrecords").btechco_excelexport({
					containerid: "beicrecords", 
					datatype: $datatype.Table,
					returnUri: true
...
var date = <?php echo date('Y_m_d_H_i_s'); ?>;
    $(function(){
    	$("#export_excel_button7").click(function () {		    
			var filename = "Gazettes_record_details"+date;
			var uri = $("#gazetterecords").btechco_excelexport({
					containerid: "gazetterecords", 
					datatype: $datatype.Table,
					returnUri: true
...
var date = <?php echo date('Y_m_d_H_i_s'); ?>;
    $(function(){
    	$("#export_excel_button8").click(function () {		    
			var filename = "Voter_record_details"+date;
			var uri = $("#voterrecords").btechco_excelexport({
					containerid: "voterrecords", 
					datatype: $datatype.Table,
					returnUri: true
...
var date = <?php echo date('Y_m_d_H_i_s'); ?>;
    $(function(){
    	$("#export_excel_button9").click(function () {		    
			var filename = "Book_record_details"+date;
			var uri = $("#bookrecords").btechco_excelexport({
					containerid: "bookrecords", 
					datatype: $datatype.Table,
					returnUri: true

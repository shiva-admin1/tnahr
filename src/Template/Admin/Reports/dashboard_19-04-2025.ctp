                                            ...
                                            <div class="card" id="c-3">
                                                    ...
                                                    <div class="orange card-inner ">
                                                        ...
                                                        <div class="text-right">
                                                            ...
                                                            <span class="orange count">
                                                                <?php echo ($beictotalcount[0]['totalrecordcount']) ? ($beictotalcount[0]['totalrecordcount']) : 0; ?>
                                                            </span>
                                                        </div>
                                                ...
                                                <div class="card-footer m-4 p-4">
                                                    <div class="row text-center">
                                                        <div class="col-md-1"></div>
                                                        <div class="col-sm-4">
                                                            <h5 class="orange">Departments<br><a data-toggle="collapse"
                                                                    href="#beic-dept" class="rotate-arrow" role="button"
                                                                    aria-expanded="false" aria-controls="go-dept"
                                                                    id="arrow-down"><i
                                                                        class="fas fa-chevron-down orange beic-d"
                                                                        style="margin-top:5px;"></i></a>
                                                            </h5>
                                                        </div>
                                                        <div class="col-md-1"></div>
                                                        <div class="col-sm-4">
                                                            <h5 class="orange">Types<br><a data-toggle="collapse"
                                                                    href="#beic-typ" role="button" aria-expanded="false"
                                                                    aria-controls="beic-typ" class="rotate-arrow"
                                                                    id="arrow-down"><i
                                                                        class="fas fa-chevron-down orange beic-t"
                                                                        style="margin-top:6px;"></i></a>
                                                            </h5>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <span class="collapse multi-collapse beic-dep"
                                                                id="beic-dept">
                                                                <div class="row">
                                                                        ...
                                                                        <h6 class="orange"
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-4 right">
                                                                                    <a class="orange" id="o-h"
                                                                                        href="./record_details/<?php echo strip_tags($value['department']); ?>/3">
                                                                                        <?php echo ($value['valcount']); ?></a>
                                                                                </div>
                                                                            </div>
                                                                        </h6>
                                                                    <?php $sno++;
                                                        ...
                                                        <div class="col-lg-12">
                                                            <span class="collapse multi-collapse beic-ty" id="beic-typ">
                                                                <div class="row">
                                            ...
                                            <div class="card" id="c-4">
                                                <div class="card-body text-center">
                                                    ...
                                                    <div class="red card-inner">
                                                        ...
                                                        <div class="text-right">
                                                            ...
                                                            <span class="count">
                                                                <?php echo ($goallcount[0]['totalgocount']) ? ($goallcount[0]['totalgocount']) : 0; ?>
                                                            </span>
                                                        </div>
                                                    </div></a>
                                                </div>
                                                ...
                                                <div class="card-footer m-4 p-4">
                                                    <div class="row text-center">
                                                        <div class="col-md-1"></div>
                                                        <div class="col-sm-4">
                                                            <h5 class="red">Departments<br><a data-toggle="collapse" href="#go-dept"
                                                                    class="rotate-arrow" role="button" aria-expanded="false"
                                                                    aria-controls="go-dept" id="arrow-down"><i
                                                                        class="fas fa-chevron-down red go-d"
                                                                        style="margin-top:5px;"></i></a>
                                                            </h5>
                                                        </div>
                                                        <div class="col-md-1"></div>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <h5 class="red">Types<br><a data-toggle="collapse" href="#go-typ" role="button"
                                                                    aria-expanded="false" aria-controls="go-typ"
                                                                    class="rotate-arrow" id="arrow-down"><i
                                                                        class="fas fa-chevron-down red go-t"
                                                                        style="margin-top:6px;"></i></a>
                                                            </h5>
                                                        </div>
                                                        <div class="col-lg-12" style="margin-left:8%;margin-right:8%;">
                                                            <span class="collapse multi-collapse go-dep" id="go-dept">
                                                                <div class="row">
                                                                    <?php foreach ($godeptcount as $key => $value) { ?>
                                                                        <h6 class="red" style="margin-top:10px;font-size:14px;">
                                                                            <div class="row">
                                                                                <div class="col-md-6 left">
                                                                                    <?php echo ($value['name']); ?>
                                                                                </div>
                                                                                <div class="col-md-4 right">
                                                                                    <a class="red" id="o-h"
                                                                                        href="./record_details/<?php echo strip_tags($value['dept']); ?>/2"><?php echo ($value['valcount']); ?></a>
                                                                                </div>
                                                                            </div>
                                                                        </h6>
                                                                    <?php $sno++;
                                                        ...
                                                        <div class="col-lg-12" style="margin-left:9%;margin-right:9%;">
                                                            <span class="collapse multi-collapse go-ty" id="go-typ">
                                                                <div class="row">
                                                                    <?php foreach ($godoctypcount as $key => $value) { ?>
                                                                        <h6 class="red" style="margin-top:10px;font-size:14px;">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-4 right">
                                                                                    <a class="red" id="o-h"
                                                                                        href="./record_details/<?php echo strip_tags($value['doctyp']); ?>/1">
                                                                                        <?php echo ($value['valcount']); ?></a>
                                                                                </div>
                                                                            </div>
                                                                        </h6>
                                                    ...
                                                    <div class="green card-inner">
                                                        ...
                                                        <div class="text-right">
                                                            ...
                                                            <span class="green count">
                                                                <?php echo ($gazettestotalcount[0]['totalrecordcount']) ? ($gazettestotalcount[0]['totalrecordcount']) : 0; ?>
                                                            </span>
                                                        </div>
                                                    </div></a>
                                                </div>

                                                <div class="card-footer text-center m-4 p-4">
                                                    <a data-toggle="collapse" href="#gz" role="button"
                                                        aria-expanded="false" aria-controls="gz"><i
                                                            class="fas fa-chevron-down fa-lg green"></i></a>
                                                    <span class="collapse multi-collapse" id="gz">
                                                        <?php foreach ($gazettescount as $key => $value) { ?>
                                                            <h6 class="green" style="margin-top:20px;font-size:13px;">
                                                                <div class="row" style="margin-left:1%;margin-right:1%;">
                                                                    <div class="col-md-8 left">
                                                                        <?php echo ($value['name']); ?>
                                                                    </div>
                                                                    <div class="col-md-4 right">
                                                                        <a class="green" id="o-h"
                                                                            href="./record_details/<?php echo strip_tags($value['doctyp']); ?>/1">
                                                                            <?php echo ($value['valcount']); ?></a>
                                                                    </div>
                                                                </div>
												...
												<a href="../bmgazettes">
                                                    <div class="card-inner">
                                                        ...
                                                        <div class="text-right">
                                                            ...
                                                            <span class=" voilet count">
                                                                <?php echo ($booktotalcount[0]['totalrecordcount']) ? ($booktotalcount[0]['totalrecordcount']) : 0; ?>
                                                            </span>
                                                        </div>
                                                    </div></a>
                                                </div>

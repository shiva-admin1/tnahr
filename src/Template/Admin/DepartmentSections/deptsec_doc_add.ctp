                ...
                <div class="col-lg-11">
                    <div class="panel portlet box portlet-red">
                        <div class="portlet-header">
                            <div class="caption">Add Department Section and Record Type Mapping</div>
                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5" style="margin-left:20px;">
                                                        <div class="input text">
                                                          	<?php echo $this->Form->control('document_type_id',['multiple' => 'checkbox', 'options' => $doc_types,'label'=>false,'error'=>false]);?>

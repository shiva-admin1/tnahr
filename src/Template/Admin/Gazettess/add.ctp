                ...
                <div class="col-lg-12">
                    <div class="panel portlet box portlet-red">
                        <div class="portlet-header">
                            <div class="caption">Add Gazette</div>
                        </div>
                        <div class="panel-body pan">
                            <div class="form-body pal">
                                <fieldset style="width:95%;margin-left:1%;border:1px solid #00355F;border-radius:10px;">
                                    <legend style="font-size:18px;margin-left:10px;color:#00355F;"><b>Gazette</b>
                                    </legend>
                                    <div class="col-md-6">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('notification_no',['class'=>'form-control alphanumeric','label'=>false,'error'=>false,'maxlength'=>'30','required'=>'false','minlength'=>'1','placeholder'=>'Notification No']);?>
                                                    </div>
                                       ...
                                       <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('notification_date',['class'=>'form-control datepicker1','label'=>false,'error'=>false,'readonly'=>'readonly','required'=>'false','type'=>'text','placeholder'=>'Notification Date']);?>
                                                    </div>
										...
										<div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('gpart',['class'=>'form-control','label'=>false,'error'=>false,'maxlength'=>'150','minlength'=>'1','required'=>'false','placeholder'=>'Part']);?>
                                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('gsection',['class'=>'form-control ','label'=>false,'error'=>false,'maxlength'=>'150','minlength'=>'1','required'=>'false','placeholder'=>'Section']);?>
                                                    </div>
                                    ...
                                    <div class="col-md-6">
										...
										<div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('abstract_subject',['class'=>'form-control ','label'=>false,'error'=>false,'maxlength'=>'250','minlength'=>'1','required'=>'false','rows'=>2,'placeholder'=>'Abstract/Subject']);?>
                                                    </div>
										 ...
										 <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('keyword_tag',['class'=>'form-control alphanumericandcomma','label'=>false,'error'=>false,'maxlength'=>'250','required'=>'false','minlength'=>'1','rows'=>3,'placeholder'=>'Keywords/Tags']);?>
                                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <a target="_blank"
                                                        href="<?php echo $this->Url->build('/', true)?><?php echo $gazettes->file_path; ?>">View
                                                        Enclosure</a>

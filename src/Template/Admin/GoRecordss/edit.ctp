                ...
                <div class="col-lg-11">
                    <div class="panel portlet box portlet-red">
                        <div class="portlet-header">
                            <div class="caption">Edit Government Order</div>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('document_subtype_id',['class'=>'form-control','label'=>false,'required'=>false,'error'=>false,'empty'=>'Select GO Type']);?>
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('go_department_id',['class'=>'form-control','label'=>false,'required'=>false,'error'=>false,'empty'=>'Select Department']);?>
                                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('go_no',['class'=>'form-control ','label'=>false,'error'=>false,'required'=>false,'maxlength'=>'50','minlength'=>'1']);?>
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('go_date',['class'=>'form-control datepicker1 calendar','required'=>false,'label'=>false,'error'=>false,'readonly'=>'readonly','type'=>'text','value'=>$this->Time->format($goRecords->go_date,'d-M-Y')]);?>
                                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('abstract_subject',['class'=>'form-control ','required'=>false,'label'=>false,'error'=>false,'maxlength'=>'250','minlength'=>'1','rows'=>2]);?>
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('keyword_tag',['class'=>'form-control ','label'=>false,'required'=>false,'error'=>false,'maxlength'=>'250','minlength'=>'1','rows'=>3]);?>
                                                    </div>
                                        ...
                                        <table class="table table-bordered table-responsive">
                                            <thead class="row-table">
                                                <tr>
                                                    ...
                                                    <th width="16%" style="text-align:center;">New Attachment</th>
                                                    <th width="16%" style="text-align:center;">Existing Document</th>
                                                </tr>
                                            </thead>
                                            <tbody>
											...
											foreach($uploadGoTypes as $key => $asset){ ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php echo $this->Form->control('document_name['.$key.']',['label'=>false,'error' => false,'required'=>false,'type'=>'hidden','class'=>'form-control specialfield trimspace','maxlength'=>'50','value'=>$asset]); ?>
                                                        <?php echo($asset); ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php echo $this->Form->control('file_path_1',['type'=>'hidden','label'=>false,'error'=>false,'required'=>false,'value'=>$goRecords->abstract_file_path]); ?>
                                                        <?php echo $this->Form->control('file_path_2',['type'=>'hidden','label'=>false,'error'=>false,'required'=>false,'value'=>$goRecords->fulldoc_file_path]); ?>

											...
											<div class="form-group">
												<div class="col-md-12">
													<div class="input text">
														...
														<?php echo $this->Form->control('village_id', ['class' => 'form-control', 'label' => false, 'error' => false, 'empty' => 'Select Village', 'options' => $villages, 'onchange' => 'villagecheck(this.value,' . $osrRecords['id'] . ')']); ?>
													</div>
												</div>
											</div>
										</div>
...
<script>
	...
	function villagecheck(val, osr_id) {
		...
		$.ajax({
			...
			url: '<?php echo $this->Url->webroot; ?>../ajaxcallingedit/' + district_id + '/' + taluk_id + '/' + val + '/' + osr_id,

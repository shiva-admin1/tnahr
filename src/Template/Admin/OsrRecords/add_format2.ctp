            			...
            			<div class="panel-body pan">
								...
								<fieldset  style="width:95%;margin-left:1%;border:1px solid #00355F;border-radius:10px;"><legend style="font-size:18px;margin-left:10px;color:#00355F;"><b>Record Details </b></legend>
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<div class="col-md-6">
												<div class="input text">
													<?php echo $this->Form->control('district_name',['class'=>'form-control name','label'=>false,'error'=>false,'maxlength'=>'250','minlength'=>'2','placeholder'=>'District Name','value'=>$adistrict]);?>
												</div>
											</div>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											...
											<div class="col-md-6">
												<div class="input text">
													<?php echo $this->Form->control('taluk_name',['class'=>'form-control name','label'=>false,'error'=>false,'maxlength'=>'250','minlength'=>'2','placeholder'=>'Taluk Name','value'=>$ataluk]);?>
												</div>
											</div>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											...
											<div class="col-md-6">
												<div class="input text">
													<?php echo $this->Form->control('village_name',['class'=>'form-control name','label'=>false,'error'=>false,'maxlength'=>'250','minlength'=>'2','placeholder'=>'Village Name','value'=>$avilname]);?>
												</div>
											</div>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											...
											<div class="col-md-6">
												<div class="input text">
													<?php echo $this->Form->control('village_no',['class'=>'form-control num','label'=>false,'error'=>false,'maxlength'=>'250','minlength'=>'1','placeholder'=>'Village Name','value'=>$avilno]);?>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									&nbsp;&nbsp;&nbsp;<iframe id ="current_image" rel =<?php echo $osrFiles[1]; ?> allowFullScreen="true" frameborder="0" height="410px" width="950px" src="<?php echo $this->Url->build('/', true);?>uploads/OSR/<?php echo $osrFiles[1]; ?>" title="View Record" style="border:none;"></iframe>

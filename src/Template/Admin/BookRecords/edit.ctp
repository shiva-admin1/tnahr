                ...
                <div class="col-lg-12">
                    <div class="panel portlet box portlet-red">
                        <div class="portlet-header">
                            <div class="caption">Edit Book</div>
                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('title',['class'=>'form-control','label'=>false,'error'=>false,'maxlength'=>'250','minlength'=>'1','placeholder'=>'Title']);?>
                                                    </div>
                                        ...
                                        <div class="col-md-12 author" <?php if($bookRecord['author'] =='') {  ?> style="display:none;" <?php } ?>>
                                            <div class="form-group">
                                                <label for="inputContent" class="col-md-4 control-label bold">Author
                                                    <span class="require">&nbsp;*</span></label>
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('author',['class'=>'form-control','label'=>false,'error'=>false,'maxlength'=>'250','minlength'=>'1','placeholder'=>'Author']);?>
                                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('subject',['class'=>'form-control name','label'=>false,'error'=>false,'minlength'=>'1','maxlength'=>'250','placeholder'=>'Subject']);?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('publication_year',['class'=>'form-control num','label'=>false,'error'=>false,'minlength'=>'1','placeholder'=>'Year of Publication','onblur'=>'callYop(this);']);?>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('accession_no',['class'=>'form-control','label'=>false,'error'=>false,'type'=>'text','placeholder'=>'Accession Number']);?>
                                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('catalogue_no',['class'=>'form-control','label'=>false,'error'=>false,'type'=>'text','placeholder'=>'Catalogue Number']);?>
                                                    </div>
                                        ...
                                        <div class="col-md-12 publisher" <?php if($bookRecord['publisher_name'] =='') {  ?> style="display:none;" <?php } ?>>
                                            <div class="form-group">
                                                <label for="inputContent" class="col-md-4 control-label bold">Publisher
                                                    <span class="require">&nbsp;*</span></label>
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('publisher_name',['class'=>'form-control','label'=>false,'error'=>false,'type'=>'text','placeholder'=>'Publisher']);?>
                                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('keyword_tag',['class'=>'form-control alphanumericandcomma','label'=>false,'error'=>false,'rows'=>'2','minlength'=>'1','maxlength'=>'250','placeholder'=>'Keyword/Tag']);?>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input text">
                                                        <?php echo $this->Form->control('file_path',['class'=>'form-control document_path resumeUpload','type'=>'file','label'=>false,'error'=>false,'required'=>false]);?>
                                                          <?php echo $this->Form->control('file_path_1',['type'=>'hidden','label'=>false,'error'=>false,'required'=>false,'value'=>$bookRecord->file_path]); ?>
                            ...
                            <div class="col-lg-7">
                                <div class="form-actions text-right none-bg">
                                     <div class="col-md-offset-3 col-md-9">
                                        <input type="hidden" name="file_paths" id="file_paths" value="<?php echo ($bookRecord->file_path === "") ? '' : $bookRecord->file_path; ?>">
...
$(function() {
    $("#FormID").validate({
        ...
        submitHandler: function(form) {
			var yop = $('#publication-year').val();
			if( (parseInt(yop)) <= 1600  || (parseInt(yop) > 2020 )){
				$(yop).val('');
				alert('Invalid Value'); 
				return false;
			}else{

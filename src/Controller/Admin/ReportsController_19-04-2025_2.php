...
public function dashboard()
	...
	$ifrquerydept = "SELECT count(department_id) as department
        ...
        $booktotalcount = $connection->execute($bookquery4)->fetchAll('assoc');
		 ...
		 $preordertypecount = $connection->execute("SELECT count(bp.id) as subtypecount	from document_subtypes as bp where bp.document_type_id=6")->fetchAll('assoc');
		 $goordertypecount = $connection->execute("SELECT count(bp.id) as subtypecount	from document_subtypes as bp where bp.document_type_id=4")->fetchAll('assoc');
		 $gazordertypecount = $connection->execute("SELECT count(bp.id) as subtypecount	from document_subtypes as bp where bp.document_type_id=7")->fetchAll('assoc');
		 $bmgazordertypecount = $connection->execute("SELECT count(bp.id) as subtypecount	from document_subtypes as bp where bp.document_type_id=9")->fetchAll('assoc');
